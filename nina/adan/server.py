...
app = FastAPI(
    title="Adan",
    description="Ada + Newton: Self-Verifying Autonomous Agent - The constraint IS the instruction",
    version="1.0.0",
)
...
async def root():
    ...
    return HTMLResponse(content="<h1>Adan</h1><p>UI not found. Use /docs for API.</p>")
...
═══════════════════════════════════════════════════════════════════════════════
ADAN SERVER
Ada + Newton: Self-Verifying Autonomous Agent
