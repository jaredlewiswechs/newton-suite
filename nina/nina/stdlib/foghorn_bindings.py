"""
═══════════════════════════════════════════════════════════════════════════════
NINA STDLIB — TinyTalk Bindings for Nina Desktop
═══════════════════════════════════════════════════════════════════════════════

This module exposes Nina kernel to TinyTalk programs.
...
def register_nina_stdlib(runtime):
    """Register Nina builtins with a TinyTalk runtime."""
...
register_foghorn_stdlib = register_nina_stdlib
